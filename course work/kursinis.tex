...
Šio darbo \textbf{tikslas} - išsiaiškinti didelių didžiųjų duomenų keliamas problemas ir kaip tos problemos yra sprendžiamos iki šiol naudotų analitinių įrankių, ir pasinaudoti „MacroBase“ duomenų analizavimo ir anomalijų aptikimo įrankį anomalijų aptikimui.\par

Darbui iškelti \textbf{uždavyniai}:\par

\begin{enumerate}
\item Aprašyti „Didžiųjų Duomenų“ keliamas problemas.
\item Aprašyti dabar naudojamus didelių duomenų analitinius įrankius.
...
\item Pateikti galutines darbo išvadas.
\end{enumerate}
...
\item \textbf{Duomenų aiškinimas} (angl. \textit{Explanation}) - vietoj paprasto sužymėtų duomenų taškų grąžinimo, „MacroBase“ jiems sugeneruoja paaiškinimus ir apjungia sužymėto srauto duomenų taškus. Duomenų srauto paduodami duomenys yra nuolatos apdorojami, nereikalingų skaičiavimų kiekio sumažinimui „MacroBase“ aiškinamieji operatoriai grąžina paaiškinimus tik gavus naudotojo užklausą.
...
„MacroBase“ sukurta anomalijų aiškinimo pagal atributus technologija yra inovatoriškas sprendimas. Be to, „MacroBase“ yra nuolatos naujinamas ir tobulinamas, ir yra daug žadantis analitinis įrankis \cite{macrobase_overview, prioritizing_attention}.
...
\subsubsubsection{Dienų, kai diskų temperatūros yra išskirtinai aukštos eksperimento rezultatai} \label{subsubsubsec:mėn}
...
\subsubsubsection{Darbo su dideliais CSV failais eksperimento rezultatai} \label{subsubsubsec:dideli}
